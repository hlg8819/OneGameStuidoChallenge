...
public class RingNumbersPurple : MonoBehaviour
{
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(22).gameObject;
        IMG.SetActive(true);
        flag1 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(23).gameObject;
        IMG.SetActive(true);
        flag2 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(24).gameObject;
        IMG.SetActive(true);
        flag3 = 1;
    }
