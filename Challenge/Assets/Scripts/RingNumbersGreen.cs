...
public class RingNumbersGreen : MonoBehaviour
{
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(16).gameObject;
        IMG.SetActive(true);
        flag1 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(17).gameObject;
        IMG.SetActive(true);
        flag2 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(18).gameObject;
        IMG.SetActive(true);
        flag3 = 1;
    }
