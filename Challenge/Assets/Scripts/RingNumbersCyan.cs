...
public class RingNumbersCyan : MonoBehaviour
{
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(19).gameObject;
        IMG.SetActive(true);
        flag1 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(20).gameObject;
        IMG.SetActive(true);
        flag2 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(21).gameObject;
        IMG.SetActive(true);
        flag3 = 1;
    }
