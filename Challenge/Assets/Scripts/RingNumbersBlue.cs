...
public class RingNumbersBlue : MonoBehaviour
{
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(13).gameObject;
        IMG.SetActive(true);
        flag1 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(14).gameObject;
        IMG.SetActive(true);
        flag2 = 1;
    }
    ...
    {
        DeactivateChildren();
        IMG = centralCircle.transform.GetChild(15).gameObject;
        IMG.SetActive(true);
        flag3 = 1;
    }
